export const ui = {
  es: {
    'site.title': 'Cristhian Melo · Desarrollador de Software',
    'site.description':
      'Especializado en Performance, SEO y Accesibilidad. Firme creyente en la importancia del diseño UX/UI y en cómo puede afectar la experiencia del usuario en un sitio web.',
    'site.keywords':
    ...
    'notFound.p3': 'Volver al inicio',

    'blog.p1': 'Artículos sobre desarrollo web, tecnología y productividad.',

    'footer.p1': 'Hecho con'
  },
  en: {
    'site.title': 'Cristhian Melo · Software Developer',
    'site.description':
      'Specialized in Performance, SEO, and Accessibility. Firm believer in the importance of UX/UI design and how it can impact the user experience on a website.',
    'site.keywords':
    ...
    'hero.p2': 'Software developer with 4+ years of experience.',
    ...
    'notFound.p2':
      'The resource you are looking for is not available or does not exist.',
    'notFound.p3': 'Back to home',

    'blog.p1': 'Articles about web development, technology, and productivity.',
